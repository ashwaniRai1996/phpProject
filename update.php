...
elseif( isset( $_POST['submit_U'] ))
  {
	    ,echo '<h2> Insert values </h2>'
		  ...
		  $Id= $_REQUEST['Id'];
		  $Percentage="";
		  if($Physics > 100 or $Chemistry >100 or $English >100 $Math >100 or $Biology>100)
		  {
		 ...
		 {			 
	          $sql="insert into student_Subject_marks VALUES($Id,$Physics,$Math,$English,$Chemistry,$Biology)"; 
